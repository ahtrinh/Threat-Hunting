...
- **Check `DeviceProcessEvents`** PowerShell execution, policy bypass, and attacker tooling
- **Check `DeviceFileEvents`** Sensitive file access, staging activity, and archive creation
- **Check `DeviceNetworkEvents`** Remote access context, outbound connections, and transfer attempts
...
```
<img width="630" height="104" alt="Screenshot 2026-02-05 at 10 41 20 PM" src="https://github.com/user-attachments/assets/dbcee4f1-4808-47cd-a435-87b5458badcb" />
